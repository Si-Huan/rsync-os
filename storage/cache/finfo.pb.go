...
func (x *TbFInfo) Reset() {
	*x = TbFInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_finfo_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TbFInfo) Descriptor() ([]byte, []int) {
	return file_finfo_proto_rawDescGZIP(), []int{1}
}
...
var file_finfo_proto_rawDesc = []byte{
	...
	,
...
var file_finfo_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_finfo_proto_goTypes = []interface{}{
	(*FInfo)(nil),   // 0: proto.FInfo
	(*TbFInfo)(nil), // 1: proto.TbFInfo
}
...
func file_finfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_finfo_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TbFInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
